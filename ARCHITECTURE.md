...
### Назначение
Высокопроизводительный Trader сервис для мониторинга и торговли на множественных криптобиржах (CEX и DEX), работающий в outbound-only модели с оркестрацией через CTS-Core.

### Ключевые характеристики
- **Масштабируемость**: множество trader-инстансов на разных хостах
- **Гибкость**: каждый инстанс может быть монитором, трейдером или обоими ролями
...
│  │  • Load monitoring/trading tasks from CTS-Core WS    │   │
│  └──────────────────────────────────────────────────────┘   │
│                         ↓                                   │
│  ┌──────────────────────────────────────────────────────┐   │
...
```
[TASK FLOW FROM CTS-CORE WS]
         ↓
[ASSIGN / UPDATE / REMOVE TASKS]
         ↓
[MERGE & DEDUPLICATE]
         ↓
